...
%La partita inizierà la sera di domenica 16 marzo 2014, con ritrovo al collegio Carducci.
...
Proposte accettate, ma ancora da implementare.

\begin{itemize}
\item Introdotto il Turlupinatore.
\item Abolito lo Spettro della Duplicazione.
% \item Lo Spettro della Mistificazione inverte la misticità invece di renderla vera.
\item L'ultimo Ipnotista, quando muore, diventa uno Spettro
  dell'Ipnosi.
\item La Spettro dell'Ipnosi non viene fatto se è già stato fatto lo
  Spettro della Morte. Lo Spettro dell'Ipnosi viene creato se l'ultimo
  Ipnotista muore la stessa notte in cui viene creato lo Spettro della
  Morte.
\item Il Profanatore di Tombe è trasferito alla fazione dei
  Popolani. Rimane con aura nera.
\item Il Necrofilo è rinominato in ???.
\end{itemize}
...
Il Profanatore di tombe conosce i Rinnegati, i Sequestratori e gli eventuali altri Profanatori di tombe.
 
 \item {\bf Rinnegato} (aura bianca). Il Rinnegato non ha alcun potere speciale.
Il Rinnegato conosce i Profanatori di tombe, i Sequestratori e gli eventuali altri Rinnegati.
...
stesso personaggio.
 ...
 Il Sequestratore conosce i Profanatori di tombe, i Rinnegati e gli eventuali altri Sequestratori.
...
se tale personaggio è diventato o meno uno Spettro.
 ...
 \item {\bf Turlupinatore} (aura bianca). Ogni notte, il Turlupinatore può scegliere
 un personaggio vivo e copiarne la scheda elettorale. Scrive inoltre il nome di
 un altro personaggio vivo sulla scheda.
 Il giorno seguente, al momento della pubblicazione dei voti, risulta che il
 personaggio scelto ha votato \emph{anche} per il personaggio il cui nome è stato scritto
 sulla scheda.
...
Sezione \ref{fallimento}).
 ...
 \item Se il Turlupinatore e lo Spettro con il potere dell'Amnesia agiscono entrambi
 su uno stesso personaggio, il voto originariamente espresso da quel personaggio
 viene cancellato (per effetto del potere dell'Amnesia), ma il voto aggiunto dal
 Turlupinatore rimane valido.
 ...
 dal Turlupinatore (a meno che abbiano agito più Turlupinatori).
 \index{Turlupinatore}
 \index{Spettro!Amnesia}
 
 \item Se più Turlupinatori agiscono su uno stesso personaggio, ciascuno di essi aggiunge
 un voto (anche se tali voti sono indirizzati al medesimo personaggio).
 \index{Turlupinatore}
 
 \item Se il Turlupinatore agisce su un personaggio che muore durante la stessa notte,
 il voto aggiunto dal Turlupinatore rimane valido.
 Al contrario, se a morire è il personaggio a cui era diretto il voto aggiunto dal Turlupinatore,
 tale voto è cancellato (e non compare tra i risultati della votazione). Ciò accade
 anche se entrambi i personaggi coinvolti muoiono.
 \index{Turlupinatore}
\end{enumerate}
