...
\paragraph{Utilizzo dei poteri} Se un personaggio con un potere cerca di attivarlo su un altro personaggio, si dice che il primo personaggio agisce sul secondo.
Un personaggio con un potere può agire 
