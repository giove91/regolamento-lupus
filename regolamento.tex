...
%  Se il personaggio pedinato dallo Stalker utilizza il proprio potere su sé stesso, lo Stalker riceve informazioni come se tale personaggio non avesse agito.
 ...
 % se il personaggio scelto è uno Spettro, ma il ruolo che aveva nel momento in cui è morto rispetta le stesse restrizioni, il Trasformista lo scopre ed ottiene tale ruolo; 
...
\begin{itemize}
 ...
 Ciascun potere soprannaturale può essere assegnato ad un solo Spettro.
...
\begin{itemize}
 \item {\bf Amnesia}. Ogni notte, lo Spettro può scegliere un personaggio vivo e ottenebrarne i ricordi. Il giorno successivo, il suo eventuale voto per il rogo viene ignorato: a tutti gli effetti è come se non avesse votato. Ciò accade anche se il personaggio scelto è sotto il controllo dell'Ipnotista o dello Spettro con il potere dell'Ipnosi: invece di votare come l'Ipnotista, o come stabilito dallo Spettro con il potere dell'Ipnosi, non vota affatto. Il potere soprannaturale dell'Amnesia non ha effetto sui componenti della Fazione dei Negromanti. % Se lo Spettro tenta di ottenebrare i ricordi dell'Ipnotista, il suo potere non ha effetto.
...
%  Questo potere non può essere usato per due notti consecutive sullo stesso personaggio.
 ...
 \item{\bf Ipnosi}. Ogni due notti, lo Spettro può scegliere un personaggio vivo e controllarne la mente. Seleziona un secondo personaggio vivo, e il giorno seguente il voto per il rogo del personaggio scelto sarà espresso contro il secondo personaggio. Il potere soprannaturale dell'Ipnosi non ha effetto sui componenti della Fazione dei Negromanti. % Se lo Spettro tenta di controllare la mente dell'Ipnotista, il suo potere non ha effetto.
...
%  \item {\bf Mistificazione}. Ogni notte, lo Spettro può scegliere un personaggio, vivo o morto, e creare un'aura magica nella sua casa. Per quella notte, il personaggio scelto è considerato mistico. 
 ...
 Il potere soprannaturale della Morte può essere assegnato solo ad un personaggio mistico. % Se lo Spettro tenta di uccidere un Lupo, il suo potere non ha effetto.
...
% \index{Fallimento dei poteri@\emph{Fallimento dei poteri}}
 ...
 \item I ruoli influenzati dal potere soprannaturale dell'Illusione sono i seguenti: Assassino, Custode del cimitero, Guardia del corpo, Stalker, Voyeur.
 \index{Spettro!Illusione}
 \index{Assassino}
 \index{Custode del cimitero}
 \index{Guardia del corpo}
