...
%  \item {\bf Nipote di Mubarak} (aura nera). Ha un potere speciale passivo: se la Nipote di Mubarak viene messa al rogo dal villaggio, non muore.
 ...
 Se il personaggio scelto non aveva un potere speciale di questo tipo, il potere del Necrofilo non ha effetto.
...
\begin{itemize}
 ...
 Da quel momento in poi il voto di quel personaggio è considerato uguale a quello dell'Ipnotista, indipendentemente dall'eventuale voto espresso; questo è vero anche se l'Ipnotista non vota.
 Il personaggio scelto non viene informata di essere sotto il controllo dell'Ipnotista.
...
%  \item Un Negromante che utilizza la propria azione notturna per ricercare un nuovo potere e contemporaneamente viene sequestrato, fallisce. Potrà nuovamente provare a ricercare quel potere soprannaturale nelle notti successive.
 ...
 \item Se lo Stalker o il Voyeur agiscono su di un personaggio che sta usando il proprio potere su sé stesso, ricevono informazioni come se quel personaggio non avesse agito.
 \index{Stalker}
 \index{Voyeur}
 ...
 \item Se più Fattucchiere agiscono sulla stessa persona, ciascuna cambia il colore dell'aura. Pertanto, il colore dell'aura percepitoa durante quella notte è quello corretto se le Fattucchiere in questione sono in numero pari, mentre è quello sbagliato se le Fattucchiere sono in numero dispari.
 \index{Fattucchiera}
