...
\begin{itemize}
	...
	\item {\bf Fantasma} (aura nera). Il Fantasma non ha alcuna abilità. Se il Fantasma muore, diventa immediatamente uno Spettro. Inoltre, se vi sono degli Incantesimi non attivi (ad eccezione di Vita), uno di essi, selezionato in modo casuale, viene attivato sul Fantasma.
