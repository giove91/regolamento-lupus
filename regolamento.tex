...
Se il potere è unico o attivabile ogni due notti, l'utilizzo conta anche in caso di fallimento, tranne nel caso i cui la causa del fallimento sia il rapimento da parte di un Sequestratore. Per esempio, un Necrofilo che usa il suo potere su un Lupo, fallisce e perde il potere per sempre. (DA CONFERMARE)

\section{Lo status di Sindaco}

Il voto del Sindaco vale 1,5 voti per stabilire se una votazione è valida e per stabilire chi muore dopo una votazione di giorno. (A SASHA NON PIACE)
