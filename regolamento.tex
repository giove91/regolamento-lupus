...
Per ora questa è una lista di proposte.

\begin{itemize}
\item Introdotto il Trasformista.
\item Abolito lo Spettro della Duplicazione. Oppure lo Spettro della
  Mistificazione.
\item In alternativa, lo spettro della Mistificazione divente una
  Spettro di Inversione della Misticità.
...
(ad esempio leggendo la posta di altri giocatori o monitorando gli accessi alle aule computer).
Altre indagini di natura informatica sono consentite.
