...
\begin{itemize}
 ...
 Se uno Spettro viene resuscitato dal Messia, continua a giocare per la fazione dei Non-morti, può nuovamente essere ucciso dall'assemblea, perde il suo Potere da Spettro, non riottiene i poteri eventualmente posseduti prima di essere stato risvegliato come Spettro, e mantiene la sua vecchia aura.
 Se viene nuovamente ucciso... (DA COMPLETARE)
\end{itemize}
