...
\begin{itemize}
	...
	\item {\bf Fantasma} (aura nera). Il Fantasma non ha alcun potere speciale. Se il Fantasma muore, diventa immediatamente uno Spettro. Inoltre, se vi sono dei poteri soprannaturali non assegnati, ne ottiene uno scelto in modo casuale.
	...
	\begin{itemize}
		\item Quando un personaggio appartenente alla Fazione dei Popolani muore, c'è la possibilità che questi divenga automaticamente uno Spettro (ciò avviene o meno a seconda di quanti altri Popolani sono morti fino a quel momento, in un modo segretamente deciso dai GM prima dell'inizio della partita). In questo caso, lo Spettro non riceve alcun potere soprannaturale; i Negromanti potranno assegnargliene uno a partire dalla notte successiva.
		\item Un personaggio morto appartenente alla Fazione dei Popolani può divenire uno Spettro successivamente, in seguito all'azione di un Negromante morto. In questo caso lo Spettro riceve immediatamente un potere soprannaturale; i Negromanti potranno modificarlo a partire dalla notte successiva.
		\item Quando un Fantasma muore, questi diviene automanticamente uno Spettro. In questo caso lo Spettro riceve immediatamente un potere soprannaturale, purché ve ne sia almeno uno non assegnato; i Negromanti potranno modificarlo (o assegnargliene uno, se non ve ne erano di disponibili) a partire dalla notte successiva.
	\end{itemize}
