...
Cacciatore, Custode del cimitero, Esorcista, Investigatore, Rinnegato, Sciamano, Negromante, Fantasma,
Ipnotista, Medium, Spettro, Scrutatore, Trasformista.
...
\item L'ultimo Ipnotista, quando muore, diventa uno Spettro
  dell'Ipnosi.
\item Lo Spettro dell'Ipnosi non viene fatto se è già stato fatto lo
...
\item Il Necrofilo è rinominato in Trasformista.
\end{itemize}
...
muore, costui assume automaticamente il potere dell'Ipnosi. Questo non avviene se 
...
un personaggio morto e contattarne lo spirito. Scopre il ruolo del personaggio e
...
Sezione \ref{fallimento}).
 ...
 %, ma prima di aver applicato gli effetti dello Spettro con il potere della Duplicazione
 .
