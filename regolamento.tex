...
\end{itemize}
Inoltre, alcune abilità non possono essere utilizzate la prima notte. Nessun personaggio può utilizzare la propria abilità o potere su sé stesso, eccetto dove diversamente specificato.
...
\begin{itemize}
	...
	\item {\bf Negromante} (aura bianca, mistico). Ogni notte, ciascun Negromante può scegliere un personaggio morto (o uno Spettro con l'Incantesimo della Vita) ed un Incantesimo non già attivo.
	...
	\item {\bf Fantasma} (aura nera). Ogni notte, il Fantasma può scegliere un Incantesimo, ed effettuare un rituale per legarsi a tale incantesimo.
    ...
    Uno Spettro che non abbia un Incantesimo attivo ha un potere: ogni notte può agire su se stesso e selezionare un Incantesimo. Allo Spettro viene applicato l'Incantesimo selezionato, ma lo Spettro non potrà usare alcun potere o abilità la notte successiva.
...
\begin{itemize}
	...
	\item {\bf Morte}. Ogni due notti, lo Spettro può scegliere un personaggio vivo e tentare di ucciderlo. Tale personaggio muore.
	...
	\item {\bf Ombra}. Ogni notte, lo Spettro può scegliere un personaggio, vivo o morto, e generare presso la sua casa un'illusione di un altro personaggio vivo. Un Voyeur o un Assassino che visitano tale casa agiranno come se quell'altro personaggio si fosse diretto verso tale casa.
	...
	\item {\bf Tormento}. Ogni due notti, lo Spettro può scegliere un personaggio vivo e tormentarne la mente. All'alba successiva, il personaggio non ricorderà nessuna informazione relativa all'utilizzo della propria abilità, ma riceverà invece un messaggio specifico.

	\item {\bf Visione}. Ogni due notti, lo Spettro può scegliere un personaggio, vivo o morto, e spiarne la casa. Scopre l'elenco di tutte le abilità, eventualmente ripetute, che sono state utilizzate quella notte su quel personaggio, ma non scopre l'identità dei giocatori che le hanno utilizzate.

	\item {\bf Vita}. Lo Spettro non ottiene alcun potere. Invece, durante l'alba successiva, ritorna in vita mantenendo ruolo ed abilità, ma continuando a giocare con la Fazione dei Lupi. Tuttavia, egli non può utilizzare abilità che sono utilizzabili una sola volta a partita (Cacciatore, Messia).
...
Ad esempio, se un Trasformista viene visitato dal Veggente durante la notte in cui utilizza la propria abilità con successo su un Mago, il Veggente lo vedrà comunque con aura nera, perché la trasformazione avviene al termine della notte.

\paragraph{Fallimento} Ci sono alcuni modi di utilizzare la propria abilità o il proprio potere che sono a priori non consentiti, e pertanto non risultano nemmeno tra le scelte disponibili sull'interfaccia web. Ad esempio, l'Investigatore non può scegliere di usare la propria abilità su un personaggio vivo; un Messia non può provare ad attivare la propria abilità se l'ha già utilizzata con successo in una notte precedente.
