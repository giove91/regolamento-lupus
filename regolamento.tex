...
\begin{itemize}
	...
	\item Sono stati introdotti i seguenti ruoli: Factotum.
...
I giocatori sono divisi in due fazioni: la Fazione dei Popolani e la Fazione dei Lupi. I componenti della Fazione dei Lupi si conoscono fra di loro sin dall'inizio della partita. I componenti della Fazione dei Popolani, invece, non hanno conoscenze iniziali se non diversamente specificato nella descrizione del ruolo.
...
Molti dei personaggi non resteranno vivi sino alla fine della partita. Un personaggio può morire in diversi modi: condannato al rogo, sbranato dai Lupi, oppure ucciso da un Cacciatore, da un Assassino.
...
\begin{itemize}
    ...
    \item {\bf Factotum} (aura bianca). Prima della prima notte e alla fine di ogni alba, al Factotum viene assegnata un'abilità di un altro ruolo da usare per la notte successiva. Il ruolo per ciascuna notte è deciso segretamente dai GM all'inizio della partita. Dopo un certo numero di notti, il Factotum perde l'ultima abilità ricevuta e smette di riceverne altre.
...
\begin{itemize}
	...
	\item {\bf Fantasma} (aura nera). Ogni notte, il Fantasma può scegliere un personaggio, vivo o morto, e un Incantesimo, ed effettuare un rituale presso la casa del personaggio scelto. Il personaggio scelto può essere anche il Fantasma stesso.
	...
	\begin{itemize}
		...
		\item Quando un Fantasma muore, questi diviene automaticamente uno Spettro. In questo caso un Incantesimo viene immediatamente attivato su tale Spettro, purché quel potere sia disponibile; i Negromanti potranno modificarlo o attivarne uno a partire dalla notte successiva.
	\end{itemize}
    ...
    Uno Spettro che non abbia un Incantesimo attivo ha un potere: ogni notte può agire su se stesso e sele
...
\begin{itemize}
	...
	\item {\bf Visione (nome da cambiare)}. Ogni due notti, lo Spettro può scegliere un personaggio, vivo o morto, e spiarne la casa. Scopre l'elenco dei ruoli (con molteplicità) di tutte le persone che hanno visitato tale casa (tuttavia, non scopre le identità di tali persone).
