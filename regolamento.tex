...
\renewenvironment{theindex}
               {\twocolumn[\section*{Indice delle parole chiave presenti nella Sezione \ref{faq}}]%
...
%  \item {\bf Nipote di Mubarak} (aura nera). Ha un potere speciale passivo: se la Nipote di Mubarak viene messa al rogo dal villaggio, non muore.
 ...
 Inoltre, se agisce su uno Spettro, ottiene il potere che quel personaggio aveva prima di diventare Spettro.
...
%  \item Un Negromante che utilizza la propria azione notturna per ricercare un nuovo potere e contemporaneamente viene sequestrato, fallisce. Potrà nuovamente provare a ricercare quel potere soprannaturale nelle notti successive.
 ...
 \index{Votazione per il rogo}
 \index{Elezione del Sindaco}
 
 \item Se più persone ottengono il massimo numero di voti per il rogo e quella scelta casualmente per essere uccisa è stata protetta dall'Avvocato del Diavolo, nessuna muore e non viene resa pubblica l'identità della persona protetta dall'Avvocato.
 ...
 \item Il potere dell'Ipnotista e i poteri soprannaturali dell'Amnesia e della Duplicazione non hanno effetto sull'elezione del sindaco, solo sul voto per il rogo.
 \index{Ipnotista}
 ...
 \item Quando lo Spettro con il potere della Duplicazione agisce, il villaggio non viene messo al corrente dell'identità della persona che ha beneficiato del potere. Per esempio, se il personaggio X viene votato da A, B e C, e durante la notte precedente lo Spettro aveva usato il suo potere su C, allora il server riporterà un messaggio simile a ``X è stato votato da A, B e C, ricevendo un totale di 4 voti''.
 \index{Votazione per il rogo}
 \index{Spettro!Duplicazione}
 
 \item Lo Spettro con il potere dell'Illusione che agisce su un personaggio X può dirigere l'illusione da X stesso. In questo caso, un eventuale Stalker che utilizzi a sua volta il suo potere su X verrebbe a sapere che X non è uscito di casa.
