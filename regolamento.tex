...
%  \index{Spettro!Ipnosi}
 ...
 \item Nel momento in cui un personaggio cambia ruolo, per esempio quando un Trasformista agisce con successo o quando beve una pozione di licantropia, tale personaggio ottiene anche l'aura ed eventualmente la proprietà di essere mistico del nuovo ruolo. Un'eccezione a questa regola è data dagli Spettri: non avendo questi aura e misticità definite, un personaggio che diviene Spettro mantiene l'aura ed eventualmente la proprietà di essere mistico del vecchio ruolo.
 \index{Spettro}
 \index{Stregone}
 \index{Trasformista}
 ...
 \item Se un personaggio fallisce nell'utilizzo del potere a causa di un Sequestratore, tale personaggio non compare nell'elenco di quelli fra cui viene sorteggiata la vittima di un eventuale Assassino che ha agito sullo stesso personaggio su cui avrebbe agito il personaggio sequestrato. % TODO È scritto da cani!
\end{enumerate}
